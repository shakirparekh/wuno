...
complete --command wentuno-qt --no-files

# Extract options
function __fish_wentunoqt_get_options
...
complete \
    --command wentuno-qt \
    --arguments "(__fish_wentunoqt_get_options --nofiles)"
