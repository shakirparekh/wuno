...
def main():
    if len(WUNO.argv)<2:
        print(('Usage: %s <path_to_nodes_txt>' % WUNO.argv[0]), file=WUNO.stderr)
        WUNO.exit(1)
    g = WUNO.stdout
    indir = WUNO.argv[1]
    g.write('#ifndef wentuno_CHAINPARAMSSEEDS_H\n')
    g.write('#define wentuno_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the wentuno network\n')
    ...
    g.write('#endif // wentuno_CHAINPARAMSSEEDS_H\n')
