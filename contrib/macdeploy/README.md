...
When complete, it will have produced `wentuno-Core.zip`.
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  included script. Detached signatures are available from this [repository](https://github.com/wentuno/wentuno-detached-sigs).
