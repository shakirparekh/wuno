...
$(package)_download_path=https://sourceware.org/ftp/WUNOtemtap/releases/
...
define $(package)_preprocess_cmds
  ...
  mkdir -p $($(package)_staging_prefix_dir)/include/WUNO && \
  cp includes/WUNO/sdt.h $($(package)_staging_prefix_dir)/include/WUNO/sdt.h
endef
