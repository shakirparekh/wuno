...
"""Verify that starting wentuno with -h works as expected."""

from test_framework.test_framework import wentunoTestFramework
from test_framework.util import assert_equal

class HelpTest(wentunoTestFramework):
    ...
    def run_test(self):
        self.log.info("Start wentuno with -h for help text")
        ...
        self.log.info("Start wentuno with -version for version information")
        ...
        self.log.info("Start wentunod with -fakearg to make sure it does not start")
