...
By default, wentunod will dump mempool on shutdown and
...
class MempoolPersistTest(wentunoTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent wentunod from writing mempool.dat to disk. Verify that `savemempool` fails")
