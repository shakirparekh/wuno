...
class PSBTTest(wentunoTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 WUNO
        ...
        self.log.info("Test walletcreatefundedpsbt fee rate of 10000 sat/vB and 0.1 WUNO/kvB produces a total fee at or slightly below -maxtxfee (~0.05290000)")
        ...
        # wentuno TODO: update values so moneyrange fails in psbt 21m vs 888m
        #assert_equal(analysis['next'], 'creator')
