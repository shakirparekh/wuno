...
class TxnMallTest(wentunoTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 WUNO:
        ...
        # First: use raw transaction API to send 1240 WUNO to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 WUNO coin each
        ...
        # Node0's balance should be starting balance, plus 50WUNO for another
        ...
        # Node0's total balance should be starting balance, plus 100WUNO for
