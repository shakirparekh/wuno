...
"""  Tests the coin_selection:* tracepoint API interface.
     See https://github.com/wentuno/wentuno/blob/master/doc/tracing.md#context-coin_selection
"""
...
class CoinSelectionTracepointTest(wentunoTestFramework):
    ...
    def skip_test_if_missing_module(self):
        ...
        self.skip_if_no_wentunod_tracepoints()
