...
This document provides guidelines for internationalization of the wentuno Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wentuno_en.ts` remains unchanged.
