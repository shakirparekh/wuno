wentuno Core version 0.14.2 is now available from:

  <https://wentuno.org/bin/wentuno-core-0.14.2/>
...
(in wentuno Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate wentuno-config.h as necessary (theuni)
