Download URL: https://sourceforge.net/projects/wentuno/files/wentuno/wentuno-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 WUNO fee schedule (users still pay 0.01 WUNO per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #wentuno00 - #wentuno99
