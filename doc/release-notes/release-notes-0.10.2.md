wentuno Core version 0.10.2 is now available from:

  <https://wentuno.org/bin/wentuno-core-0.10.2/>
...
characters (https://github.com/wentuno/wentuno/issues/6078).

For other platforms there are no notable changes.

For the notable changes in 0.10, refer to the release notes
at https://github.com/wentuno/wentuno/blob/v0.10.0/doc/release-notes.md
...
- `424ae66` don't imbue boost::fileWUNOtem::path with locale "C" on windows (fixes #6078)
