wentuno version 0.5.4 is now available for download at:
http://sourceforge.net/projects/wentuno/files/wentuno/wentuno-0.5.4/
...
http://gitorious.org/wentuno/wentunod-stable/archive-tarball/v0.5.4#.tar.gz
...
Yet another attempt at implementing "minimize to tray" that works on all operating WUNOtems.
Fix wentuno-Qt notifications under Growl 1.3.
Increase required age of wentuno-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxwentuno properly when installing wentuno-Qt over it. (Windows)
