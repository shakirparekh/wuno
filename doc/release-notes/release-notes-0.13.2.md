wentuno Core version 0.13.2 is now available from:

  <https://wentuno.org/bin/wentuno-core-0.13.2/>
...
- #8908 `4a974b2` Update wentuno-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow wentuno-tx to create v2 transactions (WUNOdrak)
