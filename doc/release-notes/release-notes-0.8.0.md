wentuno-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/wentuno/files/wentuno/wentuno-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the wentuno
...
New/changed settings (command-line or wentuno.conf file)
--------------------------------------------------------
