wentuno Core version 0.10.4 is now available from:

  <https://wentuno.org/bin/wentuno-core-0.10.4/>
...
- #6953 `43c2789` Split wentuno-tx into its own package
- #6953 `dfe0d4d` Include wentuno-tx binary on Debian/Ubuntu
