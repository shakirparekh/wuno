wentuno Core version 0.10.3 is now available from:

  <https://wentuno.org/bin/wentuno-core-0.10.3/>
...
(see https://github.com/wentuno/wentuno/pull/6793, as well as the 0.11.0
...
- #6274 `be64204` Add option `-alerts` to opt out of alert WUNOtem
