...
#ifndef wentuno_TEST_SCRIPTNUM10_H
#define wentuno_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from wentuno Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // wentuno_TEST_SCRIPTNUM10_H
