...
#ifndef wentuno_NODE_CONNECTION_TYPES_H
#define wentuno_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/wentuno-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on wentuno’s Peer-to-Peer Network")
...
#endif // wentuno_NODE_CONNECTION_TYPES_H
