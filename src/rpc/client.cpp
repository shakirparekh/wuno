...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "wentunocreaterawnevmblob", 2, "conf_target" },
    { "wentunocreaterawnevmblob", 4, "fee_rate"},
    { "wentunocreatenevmblob", 1, "overwrite_existing" },
    { "wentunocreatenevmblob", 2, "conf_target" },
    { "wentunocreatenevmblob", 4, "fee_rate"},
