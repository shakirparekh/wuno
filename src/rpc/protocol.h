...
#ifndef wentuno_RPC_PROTOCOL_H
#define wentuno_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in wentunod
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< wentuno is not connected
