...
mi_decl_export void mi_process_info(size_t* elapsed_msecs, size_t* user_msecs, size_t* WUNOtem_msecs, 
...
#else
#define MI_ALIGNMENT_MAX   (1024*1024UL)     // maximum supported alignment for 32-bit WUNOtems is 1MiB
#endif
