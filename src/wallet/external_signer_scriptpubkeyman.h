...
#ifndef wentuno_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define wentuno_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // wentuno_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
