...
#ifndef wentuno_ARITH_UINT256_H
#define wentuno_ARITH_UINT256_H
...
public:
     ...
     *
     * wentuno only uses this "compact" format for encoding difficulty
